...
另外，如果不知道人物性格怎么设定的话，我建议你可以下载一个Glow，这是[官网地址](https://glowapp.vip/)，然后到上面去找智能体，直接把它们的性格粘过来用是完全没问题的，我那个示例“小红”就是这么干的。
...
这两天在使用RWKV-4-World-CHNtuned-7B-v1-OnlyForTest_20%_trained-20230630-ctx4096这个模型的时候，发现如下配置效果好的不可思议，但是我并没有测试该配置是否适用于其他的模型：
```
{
  "top_p": 0.75,
  "temperature": 2.5,
