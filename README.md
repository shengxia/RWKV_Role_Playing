...
就目前测试来看，RWKV5效果挺不错的，1.5B的模型玩起来感觉有RWKV4 3B的水平，距离RWKV5 3B的放出还有一段时间，到时候再体验体验。我测试了RWKV5 7B训练了39%的那个，就感觉很惊艳，RWKV4给我的感觉是无情的文字续写工具，它只管通顺，不管合不合理，而RWKV5就让我感觉它真的有智能了，能听懂话了，你大可以放心的在对话中提要求，也许模型的训练量比模型的参数量更重要（RWKV5的训练量是RWKV4的一倍），更大的训练量更有利于智能的产生，听说RWKV6还会继续增加训练量，到时候效果肯定会更令人兴奋。
...
这次的更新增加了一个“指令”功能，是为了让AI的回复更有目的性，比如你想让AI做什么事儿，但是你不确定你的回复会不会让AI生成与这件事相关的回复，这时你就可以用这个功能了，直接在里面写“接下来，请描写xx去干xx。”这样的话，得到的结果就有较大的可能去干这件事情了。

另外，这次我暂时在代码中做了这样的设定，所有的动作，我都会给带上**，而指令的前后不会加任何符号，所以可能需要修改一下之前的角色卡，把示例对话和开场白稍微改一下，具体可参考示例角色卡小雪。
